...
public class MyFirstTelegramBot extends MultiSessionTelegramBot {
    ...
    public static final String NAME = "MaratonJava2024_Bot";
    public static final String TOKEN = "7005478024:AAE1KF8XzB5E5kD4W1aoiAMvOgOZ0HUguAo";
    ...
    public void onUpdateEventReceived(Update update) {
        ...
        if (getCallbackQueryButtonKey().equals("step_3_btn")){
            ...
            sendTextMessageAsync(STEP_4_TEXT,
                   Map.of("Enviar al robot por comida! +30 de fama", "step_4_btn",
                    "Dar un pase en el robot aspiradora! +30 de fama", "step_4_btn",
        ...
        if (getCallbackQueryButtonKey().equals("step_4_btn")){
            ...
            sendTextMessageAsync(STEP_5_TEXT,
                    Map.of("Encender y colocarse la GoPro", "step_5_btn"));
        }
        ...
        if (getCallbackQueryButtonKey().equals("step_5_btn")){
            ...
            sendTextMessageAsync(STEP_6_TEXT,
                ...
                "Atacar a otros gatos desde tu escondite con tu GoPro! +40 de fama", "step_6_btn",
